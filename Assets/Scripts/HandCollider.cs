...
public class HandCollider : MonoBehaviour {
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        else if(other.CompareTag("Big Spider") && PlayerAnimator.GetCurrentAnimatorStateInfo(0).IsName("Unarmed-Attack-L3") )
        {
            Debug.Log("You damaged the Big Spider");
            SpiderHealth.instance.TakeHit(9);
            ...
            SkeletonHealth.instance.TakeHit(9);
        ...
        {
            Debug.Log("You damaged the Skeleton");
            Skeleton2Health.instance.TakeHit(9);
        ...
        {
            Debug.Log("You damaged the Skeleton");
            Skeleton3Health.instance.TakeHit(9);
        ...
        {
            Debug.Log("You damaged the Skeleton");
            Skeleton4Health.instance.TakeHit(9);
        ...
        {
            Debug.Log("You damaged the Skeleton");
            Spider1Health.instance.TakeHit(9);
            Debug.Log("Skeleton: " + Spider1Health.instance.currentHealth);
        }
        else if (other.name == "mini Spider (2)" && PlayerAnimator.GetCurrentAnimatorStateInfo(0).IsName("Unarmed-Attack-L3"))
        {
            Debug.Log("You damaged the Skeleton");
            Spider2Health.instance.TakeHit(9);
            Debug.Log("Skeleton: " + Spider2Health.instance.currentHealth);
        }
        else if (other.name == "mini Spider (3)" && PlayerAnimator.GetCurrentAnimatorStateInfo(0).IsName("Unarmed-Attack-L3"))
        {
            Debug.Log("You damaged the Skeleton");
            Spider3Health.instance.TakeHit(9);
            Debug.Log("Skeleton: " + Spider3Health.instance.currentHealth);
        }
        else if (other.name == "mini Spider (4)" && PlayerAnimator.GetCurrentAnimatorStateInfo(0).IsName("Unarmed-Attack-L3"))
        {
            Debug.Log("You damaged the Skeleton");
            Spider4Health.instance.TakeHit(9);
            Debug.Log("Skeleton: " + Spider4Health.instance.currentHealth);
        }
